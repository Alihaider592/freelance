...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! Creating an account and browsing projects is completely free.",
  },
  {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          {faqs.map((faq, index) => (
            <div
              ...
              className="relative p-6 bg-gray-900 rounded-2xl backdrop-blur-md border border-white/20
